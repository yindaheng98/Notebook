# (转载) 从图(Graph)到图卷积(Graph Convolution): 漫谈图神经网络

[原文在此](https://github.com/SivilTaram/Graph-Neural-Network-Note)
...
![图像与图示例](./images/image-1-image-and-graph.png)
...
![更新公式示例](./images/image-2-state-update-function.png)
...
![更新公式示例](./images/image-4-state-flow.png)
...
![化合物分子结构](./images/image-6-gnn-example.png)
...
![更新公式示例](./images/image-3-contraction-map.png)
...
![GNN与RNN的区别](./images/image-5-gnn-rnn.png)
...
![OverSmooth](./images/image-9-over-smooth.gif)
...
![GGNN实例](./images/image-7-ggnn.png)
...
![GGNN语义解析实例](./images/image-8-ggnn-example2.png)
...
![GGNN语义解析实例](./images/image-9-cnn-and-gcn.png)
...
![图卷积神经网络全貌](./images/image-10-gcn-framework.png)
...
![卷积基本概念](./images/image-11-convolution-basic.png)
...
![信号处理中的卷积](./images/image-12-conv-signal.gif)

![深度学习中的卷积](./images/image-13-conv-cnn.gif)
...
![最简单的空域卷积](./images/image-12-basic-spatial-conv.png)
...
![MPNN网络模型](./images/image-13-mpnn.png)
...
![GraphSage采样过程](./images/image-14-graphsage.jpg)
...
![Pathcy-san framework](./images/image-14-pathcy-san-framework.png)

下图可能可以帮助读者更好地理解这种算法，图来自[12]。整个流程自底向上：首先根据自定义规则对图里的结点进行排序，然后选择前6个结点，即图中的 1至6；接着我们把这些结点

![Patchy-san 具体样例](./images/image-15-pathcy-san-detail.png)
...
![傅里叶变换的示例](./images/image-15-ft-example.gif)
...
![傅里叶变换的示例](./images/image-16-ft-transoform-before.jpg)

只要在频谱图中擦除这些点，就可以将背景条纹去掉，得到下图右侧的结果。

![傅里叶变换的示例](./images/image-17-ft-transoform-after.jpg)
...
![傅里叶变换的示例](./images/image-18-ft-cnn-example.png)
...
![拉普拉斯矩阵](./images/image-19-graph-laplacian-matrix.png)
...
![示意图](./images/image-20-graph-spectral-network.png)
...
![图重构](./images/image-21-graph-isomorphism.jpg)
...
![直方图](./images/image-22-histogram.png)
...
![模糊直方图](./images/image-23-fuzzy-histogram.png)
...
![可微池化](./images/image-24-diff-pool.png)
...
![结点聚类](./images/image-25-soft-cluster.png)
